...
public class ApiOperatorDemo implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        zookeeper = new ZooKeeper(Constants.CONNECT_STRING, 5000, new ApiOperatorDemo());
    ...
    public static void getMyState() throws KeeperException, InterruptedException {
        ACL acl = new ACL(ZooDefs.Perms.ALL, new Id("ip", "192.168.100.11"));
        List<ACL> acls = new ArrayList<>();
        acls.add(acl);
        zookeeper.create("/authTest", "111".getBytes(), acls, CreateMode.PERSISTENT);//持久节点
